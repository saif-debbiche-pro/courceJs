...
copy of Julia's array, and remove the cat ages from that copied array 
...
const checkDogs=function(dogsJulia,dogsKate){
    ...
    const displayDogs=function(dogAges=[]){
        dogAges.forEach((age,i) => {
            const str=age > 3?`Dog number ${i} is an adult, and is ${age} years old`:`Dog number ${i} is still a puppy 🐶`;
            console.log(str);
        });
       
    }
    displayDogs(dogsAges);
